...
//creates the audio tracks and assigns them to variables
...
// plugin source:
// Gerson, Leon. 2013. “noUiSlider”. refreshless.com. Accessed 7th November, http://refreshless.com/nouislider/
        $('#s1').noUiSlider({
			handles: 1,
    		range: [0, 100]
   			,start: [50]
   			,slide: function(){
				...
				value1=value1/100 //have to do this because volume property requires a number between 0.0 and 1.0
